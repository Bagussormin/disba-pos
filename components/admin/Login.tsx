...
// 🔥 KABEL LOGO RESMI DIHIDUPKAN KEMBALI (DENGAN 1 TITIK JALUR YANG BENAR)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden italic bg-[#020617]">
      ...
      <div className="glass-card w-full max-w-[310px] rounded-[2.5rem] p-8 shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/10 relative z-20 bg-black/40 backdrop-blur-xl">
        ...
        {/* BRANDING DENGAN LOGO ASLI */}
        <div className="text-center mb-6">
          <div className="flex justify-center mb-4">
            <div className="relative group">
              <div className="absolute inset-0 bg-blue-500 blur-2xl opacity-30 animate-pulse"></div>
              
              {/* GAMBAR LOGO DISBA POS */}
              <div className="relative w-20 h-20 rounded-2xl overflow-hidden shadow-2xl border border-blue-500/30 p-1 bg-black flex items-center justify-center">
                 <img src={logoDisba} alt="DISBA Logo" className="relative z-10 w-full h-full object-cover rounded-xl" />
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-black/60 border border-white/5 rounded-xl px-5 py-3 text-sm text-white placeholder:text-gray-800 outline-none focus:border-blue-500/50 transition-all font-bold not-italic"
            />
          </div>
